    ...
    return(
        ...
        <div className="grid grid-flow-col bg-[#F6F6F6] dark:bg-[#181818] border-[#EBEBEB] dark:border-[#383737] rounded-[32px] mb-[32px] ">
            <div className="left py-[32px] px-[24px] lg:py-[60px] lg:pl-[60px] flex flex-col">
                ...
                <a className='text-[18px] text-[#181818] dark:text-white font-medium flex items-center gap-[11px] lg:mt-auto' href={href}>{linktext} <img className='w-[18px] h-[12px]' src={rightwhitearrow} alt="rightwhitearrow"/></a>
            </div>
